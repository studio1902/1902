    ...
    article:
          ...
          values:
            ...
            html: |-
              <div class="tw-py-8 tw-flex tw-items-center">
                <div class="mask tw-w-full tw-aspect-[3/1]">
      ...
      -
        ...
        content:
          -
            type: text
            text: "This technique fits well with more organic designs. You can use it to clip full width elements like hero's or footers, but also images or to to make a modal a little boring. I've used them a lot on "
          -
            type: text
            marks:
              -
      ...
      -
        ...
        content:
          ...
          -
            type: text
            text: " of the SVG is set to 0 as we don't actually want to render this SVG as is. We only want to reference it to clip another part of the page. An image for example. The "
          -
            type: text
            marks:
              -
