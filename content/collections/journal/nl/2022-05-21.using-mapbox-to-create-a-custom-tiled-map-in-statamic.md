    ...
    article:
      -
        ...
        content:
          ...
          -
            type: text
            text: ' drew a beautiful illustration of the estate. The goal of this post is to make this illustration interactive and zoomable and filled with interactive points of interest. '
      -
        type: set
        attrs:
          values:
                  ...
                  style: {
                    ...
                    'sources': {
                      'raster-tiles': {
                        'type': 'raster',
                        'tiles': [
                          // Use the custom map tiles.
                          'PATH_TO_YOUR_TILES/{z}/tile_{x}_{y}.jpg'
                        ],
                        // Divide the actual tile size in pixels by 2 to support retina displays.
                        'tileSize': 128,
                        'attribution': ''
                      }
                    },
                    'layers': [
                      {
                        ...
                        'type': 'raster',
                        'source': 'raster-tiles',
                        // Set the amount of zoom levels (folders) available in your tileset.
                        'minzoom': 0,
                        'maxzoom': 6
                      }
                    ]
          ...
          values:
            ...
            code_snippet:
              code: |-
                ...
                {{ /if }}
              mode: javascript
            caption: 'Log the cursor position on local environments.'
      -
        type: paragraph
        content:
          -
            type: text
            text: 'This way when you inspect the map (on a local environment) and hover over it you get live coördinates of where we you''re hovering. Handy! Simply copy the values for each point of interest and add them as a collection entry with all the other fields you need for your project.'
      -
        type: paragraph
        content:
          -
      ...
      -
        ...
        content:
          -
            type: text
            text: 'For each collection entry this dot needs to be renderend. You can do this by simply looping over your collection with Antlers tags.'
      -
        type: set
        attrs:
          values:
                ...
                map.on('load', () => {
                    ...
                    map.addSource('features', {
                        ...
                        'data': {
                            ...
                            'features': [
                              	// Use Antlers to loop over our map_features collection.
      ...
      -
        ...
        content:
          -
            type: text
            text: 'The map is almost done. The last thing you should do is make the dots interactive and to let them show the primitive HTML we wrote in the snippet above.'
      -
        type: set
        attrs:
          values:
              ...
              code: |-
                window.map = function () {
                    return {
                        ...
                        open: false,
                      	// The map should only be rendered once.
                        rendered: false,
                        component: {
                            ...
                            'x-trap.inert.noscroll'() {
                          	...
                          	// Listen to an open-map event and when it's dispatched open the modal and render the map.
                            '@open-map.window'() {
      ...
      -
        ...
        content:
          -
            type: text
            text: 'To open the map simply run add the following AlpineJS code on any button:'
      -
        type: set
        attrs:
          values:
            ...
            code_snippet:
              code: |-
                <button x-data="" @click.prevent="$dispatch('open-map')" class="">
                	Open map
                </button>
              mode: htmlmixed
      ...
      -
        ...
        content:
          -
            type: text
            text: 'If you liked this post, please let me know on '
          -
            type: text
            marks:
              -
...
og_image: using-mapbox-to-create-a-custom-tiled-map-in-statamic-og-1653334076.png
twitter_image: using-mapbox-to-create-a-custom-tiled-map-in-statamic-twitter-1653334076.png
language: en
---
