    ...
    article:
      ...
      -
        ...
        content:
          -
            type: text
            text: "My Statamic Starter Kit Peak uses Bard as the editor for long form content like this very article. Within it I have various sets like a figure, a code block and a table. If you don't use Peak you have to do the following manually. To quickly scaffold a new set in Peak however, simply run "
          -
            type: text
            marks:
              -
